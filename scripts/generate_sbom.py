...
Usage:
    ...
    python scripts/generate_sbom.py --apply  # Apply changes to SBOM.json + SBOM.md

Reads:
  - requirements.txt   (all pinned runtime versions)
...
def main() -> None:
    ...
    for path in (SBOM_PATH, REQUIREMENTS_PATH):
        if not path.exists():
